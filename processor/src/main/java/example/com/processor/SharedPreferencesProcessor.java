...
public class SharedPreferencesProcessor extends AbstractProcessor {
    ...
    private MethodSpec buildGetMethod(VariableElement member, String configKey) {
        ...
        StringBuffer stringBuffer = new StringBuffer("return com.netease.xmtoollibrary.utils.SharedPreferenceUtil.getInstance(");
        ...
        stringBuffer.append(DEFAULT_VAULE);
        stringBuffer.append(")");
        getMethod.returns(parameterType);
        getMethod.addParameter(parameterType, DEFAULT_VAULE);
