package com.effective.android.base.keeplive;
...
import com.effective.android.base.keeplive.notification.KeepLiveService;
import com.effective.android.base.databinding.ActivityKeepaliveLayoutBinding;
 ...
 * blog: yummylau.com
 */
public class KeepLiveDemoActivity extends BaseBindingActivity<ActivityKeepaliveLayoutBinding> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.onePxKeep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startService(new Intent(KeepLiveDemoActivity.this, com.effective.android.base.keeplive.onepx.KeepLiveService.class));
            }
        });
    }
}
