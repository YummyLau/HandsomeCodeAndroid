...
public class FeatureListFragment extends BaseFragment<AppFragmentFeatureListBinding> {
    ...
    private void initData() {
        ...
        String s = new String("跳转到组件router跳转到组件router跳转到" +
                "组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router"+
                "组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router"+
                "组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router"+
                "组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router"+
                "组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router跳转到组件router");
        SpannableString spannableString = new SpannableString(s);
        spannableString.setSpan(new ForegroundColorSpan(Color.RED),0,50, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        featureAdapter.add(new FeatureItem(ItemType.CHANGE_SKIN, spannableString));
    }
